...
def get_model() -> Any:
    ...
    if llm_provider == "huggingface":
        # Uses HF_TOKEN from environment automatically if available
        # or falls back to public API if rate limits allow
        return HuggingFaceModel(settings.huggingface_model or "meta-llama/Llama-3.1-70B-Instruct")
...
class JudgeHandler:
    ...
    Unified handler for OpenAI, Anthropic, and Hugging Face.
    """
